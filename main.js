...
function updateCoinDeskApi (startDate, endDate, currency) {
...
function printHistoricalData(startDate,endDate,currency) {
  updateCoinDeskApi(startDate, endDate, currency)
  .then(result => {
    printChartWithData(result);
  })
  .catch(err=> {
...
/* GET THE CHOOSEN DATES AND CURRENCY AND PRINT CHART */

function printFinalChart() {
  let startDate = $("#start-date").val();
  let endDate = $("#end-date").val();
  let currency = $("#currency").val();
  printHistoricalData(startDate, endDate, currency)
  debugger
}
